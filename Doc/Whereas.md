<details>
  <summary><strong>(01) TLDR: EU wants common rules</strong> to make digital products more secure because cyberattacks are growing and users can’t easily choose or use safe products.</summary>
...
<details>
  <summary><strong>(02) TLDR: This Regulation sets conditions</strong> for developing secure digital products and for users to choose and use them safely.</summary>
...
<details>
  <summary><strong>(03) TLDR: Current EU cybersecurity rules</strong> cover some related aspects, but don't yet set mandatory security requirements for products with digital elements.</summary>
...
<details>
  <summary><strong>(04) TLDR: There is no single EU framework</strong> for cybersecurity of digital products, creating a legal uncertainty, so the EU wants harmonised, horizontal requirements for all such products, including those used and made by SMEs.</summary>
...
<details>
  <summary><strong>(05) TLDR: Authorities must apply all the rules of Recommendation 2003/361/EC</strong>, including how to count staff and finances for partner and linked enterprises, when classifying a company as a micro or SME.</summary>
...
<details>
  <summary><strong>(06) TLDR: The Commission will give guidance to help</strong> economic operators, especially SMEs, apply this Regulation, explaining its scope, support periods, links with other EU laws and what a substantial modification is.</summary>
...
<details>
  <summary><strong>(07) TLDR: The EU wants an ambitious common cybersecurity framework</strong> for connected products because many EU institutions, citizens and other countries are calling for strong rules in this area.</summary>
...
<details>
  <summary><strong>(13) TLDR: Member States cannot add extra cybersecurity rules</strong> but public and private buyers may demand stricter conditions for their use or procurement and adopt national measures on non-technical factors, as long as these comply with EU law.</summary>
...
<details>
  <summary><strong>(14) TLDR: This Regulation does not affect Member States’ responsibility for national security</strong>, and they may impose extra measures on digital products used for security or defence, as long as these comply with EU law.
</summary>
...
<details>
  <summary><strong>(15) TLDR: This Regulation applies to economic operators</strong> only when digital products are supplied as part of a commercial activity (payment, monetisation or profit-making donations), but not when donations only cover costs.</summary>
...
<details>
  <summary><strong>(18) TLDR: Free and open-source software with openly shared source code only falls under this Regulation when it is monetised or otherwise supplied commercially; </strong>non-monetised projects, components and contributions (including from genuine non-profits) stay outside its scope.</summary>
