...
<details>
  <summary><strong>(05) Authorities must apply all the rules of Recommendation 2003/361/EC</strong>, including how to count staff and finances for partner and linked enterprises, when classifying a company as a micro or SME.</summary>
...
<details>
  <summary><strong>(09) All products with digital elements can be an attack vector.</strong> Manufacturers must ensure all products, even less critical or indirect, meet essential cybersecurity requirements.</summary>
...
<details>
  <summary><strong>(11) Remote data processing solution</strong> security for products must be covered by this regulation if it is provided by the manufacturer and is essential for a product’s functions, but this does not extend to securing the manufacturer’s wider networks.</summary>
...
<details>
  <summary><strong>(23) Both Member States and the Commission must support especially SMEs with cybersecurity training and skills development.</strong></summary>
...
<details>
  <summary><strong>(30) This Regulation’s cybersecurity rules align with existing radio equipment rules</strong>, so standardisation work must be reused if Delegated Regulation 2022/30 changes, and the Commission should guide manufacturers that must comply with both during the transition.</summary>
...
<details>
  <summary><strong>(48) The Commission may add or remove categories of critical products that must get EU cybersecurity certification</strong> when they are key dependencies for essential entities or critical supply chains, taking into account national and EU-level risk assessments.</summary>
...
<details>
  <summary><strong>(49) The Commission must regularly consult relevant stakeholders, especially manufacturers, when updating the lists of important or critical products, to assess cybersecurity risks and weigh costs and benefits.</strong></summary>
...
<details>
  <summary><strong>(51) High-risk AI systems that are products with digital elements must meet this Regulation’s essential cybersecurity requirements (including AI-specific risks like data poisoning and adversarial attacks)</strong>; they can then reuse this compliance for AI Act Article 15, and generally follow AI Act conformity procedures except that important or critical products must still use this Regulation’s stricter cybersecurity conformity assessment.</summary>
...
<details>
  <summary><strong>(54) Manufacturers must handle vulnerabilities throughout the support period</strong> and, based on a cybersecurity risk assessment for each product, decide which other essential cybersecurity requirements apply so they can ship products without known exploitable vulnerabilities.</summary>
...
<details>
  <summary><strong>(55) If a cybersecurity requirement doesn’t fit a product, the manufacturer must justify this in the risk assessment and still address any related risks (for example by limiting use to trusted environments or warning users).</strong></summary>
...
<details>
  <summary><strong>(56) Manufacturers must design products to support (and inform users about) timely security updates</strong> — ideally automatic with an easy opt-out—inform users of vulnerabilities and end of support, while exempting components and professional/industrial products where automatic updates aren’t expected.</summary>
